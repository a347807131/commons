...
public class ImageCutterUtils {
    ...
    public static Image cutImage(BufferedImage image, int x, int y, int width, int height) throws Exception {
        // 读取图片信息
...
//        ImageCutterUtil.getOSSupportsStandardImageFormat();
        ...
        try {
            ...
            ImageCutterUtils.cutImage(file, destFile, x, y, width, height);
